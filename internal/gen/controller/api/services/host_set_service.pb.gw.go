...
var (
	filter_HostSetService_ListHostSets_1 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	...
	pattern_HostSetService_ListHostSets_1 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "host-sets"}, "list"))
